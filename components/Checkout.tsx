...
const Checkout: React.FC<CheckoutProps> = ({ items, onComplete, onBack }) => {
  ...
  const handleFinalize = () => {
    ...
    const mappedItems: OrderItem[] = items.map(i => ({
      productId: i.id,
      slug: i.slug,
      titleAtPurchase: i.name,
      priceAtPurchase: i.price,
      qty: i.quantity,
      imageAtPurchase: i.image
    }));
    ...
    const newOrder: Order = {
      ...
      customer: {
        name: 'GUEST OPERATIVE', // Hook up to actual inputs later
        phone: 'ENCRYPTED',
        address: 'SECTOR DEPLOYMENT'
      },
      items: mappedItems,
      subtotal,
        ...
        <div className="lg:col-span-8">
          ...
          {step === 3 && (
            <div className="text-center py-20 space-y-6 animate-in zoom-in-95 duration-700">
              ...
              <button
                onClick={() => onComplete(generatedOrderId!)}
